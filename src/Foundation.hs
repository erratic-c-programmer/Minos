...
instance YesodAuth App where
  ...
  authenticate creds = liftHandler $
    runDB $ do
      x <- getBy $ UniqueUserUname $ credsIdent creds
      case x of
        Just (Entity uname _) -> return $ Authenticated uname
        Nothing -> undefined  -- TODO

  -- You can add other plugins like Google Email, email or OAuth here
  authPlugins app = [authHashDB (Just . UniqueUserUname)] ++ extraAuthPlugins
    where
